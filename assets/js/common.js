        ...
        if (!isMobile() &&  !$('body').hasClass("disable-cursor")) {
            ...
            if($('.portfolioCarItam, .portfolioCarItam02').hasClass('projectItemView')){
                $('.projectItemView').on('mouseenter', function(){
                    ...
                    if($('.portfolioCarItam02').hasClass('projectItemView')){var Linecolor = '#C86DFF';} 
            ...
            $(document).ready(function() {
                let testimonials = [
                    {
                        ...
                        status: 'Happy Client',
                        text: 'Nemo enim ipsam voluptatem quia voluptas sit asperna aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciuntporro quisquam est, rui dolorem ipsum quia dolor sit amet, consectetur adieisci velit sed ruia.'
                    },
                    {
                        rating: 75,
                        name: 'Kevin James',
                ...
                function updateTestimonial(index) {
                    ...
                    $testimonialContainer.removeClass('fade-in').addClass('fade-out');
            
                    setTimeout(() => {
                        $('.rating').text(testimonials[index].rating);
                        $('.client-name').text(testimonials[index].name);
                        $('.client-status').text(testimonials[index].status);
                        $('.testimonial-text').text(testimonials[index].text);
            
                        $testimonialContainer.removeClass('fade-out').addClass('fade-in');
                    }, 500);
                }
            ...
            $(".sticky.left").mouseenter(function(e) {		  
                ...
                gsap.to(ball, { duration: 0.5, x: positionX, y: positionY, scale:0.45, opacity:1, borderWidth: '4px', borderColor:'#C86DFF'});
            ...
            $(".btnWrapper_sm.sticky.right").mouseenter(function(e) {		  
                ...
                gsap.to(ball, { duration: 0.5, x: positionX, y: positionY, scale:0.40, opacity:1, borderWidth: '4px', borderColor:'#C86DFF'});
                gsap.ticker.remove(updatePosition);
            })
            ...
            $(".parallax-wrap.iconWrapper").mouseenter(function(e) {
                gsap.to(ball, { duration: 0.3, scale: 0.45, borderWidth: '4px', opacity:1, borderColor:'#C86DFF' });
                gsap.to($( this ).children(), {duration: 0.3, scale:1, color: '#C86DFF'});
            });
            $(".iconWrapper_sm.parallax-wrap.iconWrapper").mouseenter(function(e) {
                gsap.to(ball, { duration: 0.3, scale: 0.40, borderWidth: '4px', opacity:1, borderColor:'#C86DFF' });
                gsap.to($( this ).children(), {duration: 0.3, scale:1, color: '#C86DFF'});
            });
